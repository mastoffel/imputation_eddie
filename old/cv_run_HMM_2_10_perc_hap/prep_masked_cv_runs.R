...
main_files <- paste0("/exports/eddie/scratch/v1mstoff/cv_run_HMM_2_10_perc_hap/chr_", 
                     chr_num, "/AI_main_files/")
# chromosome folder
output_masked_run_to <- paste0("/exports/eddie/scratch/v1mstoff/cv_run_HMM_2_10_perc_hap/chr_", 
                        chr_num, "/")
